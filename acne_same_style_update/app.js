    ...
    programs: [
      {
        ...
        summary:[
          '압출 + LED 재생레이저 + 스케일링 + 모델링팩 (2회)',
          '압출 + 진정관리 + 모델링팩 (2회)'
        ],
        details:`구성

1회차 · 3회차
• 압출 + LED 재생레이저 + 스케일링 + 모델링팩

2회차 · 4회차
• 압출 + 진정관리 + 모델링팩

*내원 : 주 1회 x 4주 (피부 상태에 따라 조정 가능)
*시술 기간 내 피부 상태•의료진 판단에 따라 염증주사 S/V 및 여드름약 처방 S/V 포함`
      },
      {
        id:'acne-6w',
        name:'여드름 6주 Program',
        ...
        effects:['여드름','염증 진정','피지'],
        summary:[
          '압출 + LED 재생레이저 + 카프리레이저·스케일링 + 모델링팩 (3회)',
          '압출 + 진정관리 + 모델링팩 (3회)'
        ],
        details:`구성
...
*시술 기간 내 피부 상태•의료진 판단에 따라 염증주사 S/V 및 여드름약 처방 S/V 포함`
      },
      {
        ...
        summary:[
          '여드름 맞춤치료 (당일 진료 후 레이저/관리 구성) (8회)'
        ],
        details:`구성

1회차 - 8회차
• 당일 여드름 진료 후 맞춤 레이저 치료

*내원 : 주 1회 x 8주 (피부 상태에 따라 조정 가능)
*시술 기간 내 피부 상태•의료진 판단에 따라 염증주사 S/V 및 여드름약 처방 S/V 포함`
      },
      {
        id:'scar-erase-8w',
        name:'자국지우기 8주 Program',
        price:990000,
        effects:['여드름 자국','색소','피부결'],
        summary:[
          '압출 + LED 재생레이저 + 레블라이트+제네시스+노블린·스케일링 + 모델링팩 (4회)',
          '압출 + LED 재생레이저 + 피코MLA 레이저 + 모델링팩 (4회)'
        ],
        details:`구성

1회차 · 3회차 · 5회차 · 7회차
• 압출 + LED 재생레이저 + 자국레이저+스케일링 + 모델링팩

2회차 · 4회차 · 6회차 · 8회차
• 압출 + LED 재생레이저 + 피코MLA 레이저 + 모델링팩
...
const LASER_TERMS = [
  ...
  '맥스지','피코 532','압출','카프리레이저','피코MLA 레이저','자국레이저','제네시스','노블린','스케일링','진정관리'
];
