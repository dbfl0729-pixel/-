...
const programSections = [
  ...
  },
  {
    ...
    programs:[
      ...
      {id:'scar_pico_cross_full',name:'피코프락셀+CROSS+재생 (풀페이스)',price:440000,effects:['여드름흉터','모공','피부결'],details:'1회 44만원\n3회 121만원\n5회 187만원'},
      {id:'scar_pico_cross_cheek',name:'피코프락셀+CROSS+재생 (양볼)',price:385000,effects:['여드름흉터','모공','피부결'],details:'1회 38.5만원\n3회 99만원\n5회 154만원'},
      {id:'scar_clo_full',name:'CLO+재생 (풀페이스)',price:880000,effects:['흉터','피부결'],details:'1회 88만원\n3회 220만원\n5회 330만원'},
      {id:'scar_subcision_cheek',name:'피코프락셀+CROSS+서브시전 (양볼)',price:550000,effects:['깊은흉터','함몰흉터'],details:'1회 55만원\n3회 154만원\n5회 220만원'}
    ]
  },
  {
    key: 'lifting',
      ...
      card.innerHTML = `
        <div class="cardRow">
          ...
          <div style="display:flex;gap:8px;align-items:center">
            ...
            <div class="price">${fmt(displayPrice)}원</div>
          </div>
        </div>
    ...
    d.innerHTML = `
      <div class="card" style="background:rgba(15,19,32,.35)">
        <div class="cardRow">
          ...
          <div class="price">${fmt(livePrice)}원</div>
        </div>
